    ...
    <body>
        ...
        <div id="page-container" class="main-content-boxed">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="bg-image" style="background-image: url('../assets/img/photos/Header.jpg');">
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class=" font-w700" href="index.html">
                                            <img class="img-detail" src="../img/logo-ifc.png" style="width: 50%;" alt="">
                                    </a>
                                    <h1 class="h3 font-w700 mt-10 mb-10">Welcome to Your Dashboard</h1>
