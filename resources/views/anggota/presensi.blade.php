...
<div class="block">
    <div class="block-header block-header-default pb-0">
        <h2 class="block-heading mb-0">Data Presensi Kegiatan UKM Sepakbola ITS</h2>
    </div>
            ...
            <table class="js-table-sections table table-hover">
                ...
                <tbody class="js-table-sections-header">
                    <tr>
                        ...
                        <td class="font-w600">Latihan Rutin Minggu 1</td>
                        <td>
                            <span>3</span>
                        </td>
                        <td class="d-none d-sm-table-cell">
                            <em class="text-muted">Desember 10, 2017 18:00</em>
                        </td>
                    </tr>
                </tbody>
                <tbody>
                    <tr>
                        ...
                        <td class="font-size-sm"><button type="button" class="btn btn-sm btn-rounded btn-outline-danger mr-1 js-swal-confirm">
                                    Hapus
                                </button></td>
                        <td class="d-none d-sm-table-cell">
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><button class="btn btn-sm btn-rounded btn-primary" data-toggle="modal" data-target="#modaltambahpeserta"><i class="fa fa-plus"></i> Tambah Presensi</button>
                        </td>
                    </tr>
                </tbody>
                <tbody class="js-table-sections-header table-active">
                    <tr>
                        ...
                        <td class="font-w600">Latihan Rutin Minggu 2</td>
                        <td>
                            <span>3</span>
                        </td>
                        <td class="d-none d-sm-table-cell">
                            <em class="text-muted">Desember 15, 2018 18:00</em>
                        </td>
                    </tr>
                </tbody>
                <tbody>
                ...
                <tbody class="js-table-sections-header">
                    <tr>
                        ...
                        <td class="font-w600">Cangkruk dan Main Bareng (CAMABA)</td>
                        <td>
                            <span>1</span>
                        </td>
                        <td class="d-none d-sm-table-cell">
                            <em class="text-muted">Desember 31, 2017 20:00</em>
                        </td>
                    </tr>
                </tbody>
                <tbody>
        ...
        <div class="modal fade" id="modaltambahpeserta" tabindex="-1" role="dialog" aria-labelledby="modal-popin" aria-hidden="true">
            <div class="modal-dialog modal-dialog-popout" role="document">
                <div class="modal-content">
                    <div class="block block-themed">
                        <div class="block-header bg-gd-aqua">
                            <h3 class="block-title">Tambah Presensi</h3>
                            <div class="block-options">
                                <button type="button" class="btn-block-option" data-toggle="block-option" data-action="state_toggle" data-action-mode="demo">
                                    <i class="si si-refresh"></i>
                                </button>
