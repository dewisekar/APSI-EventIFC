...
<!--[if gt IE 9]><!--> <html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
        ...
        -->
        <div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-boxed" style="background-color: #f7f4e5">
            <!-- Side Overlay-->
            ...
            <nav id="sidebar">
                ...
                <div id="sidebar-scroll" style="background-color: #c1c351">
                    <!-- Sidebar Content -->
                    <div class="sidebar-content">
                        ...
                        <!-- Side User -->
                        <div class="content-side content-side-full content-side-user px-10 align-parent" style="background-color: #82821c">
